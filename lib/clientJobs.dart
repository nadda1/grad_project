  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ...
          : hasError
              ? Center(child: Text('Failed to load jobs'))
              : jobs.isEmpty
                                  ...
                                  if (hiredApplications != null &&
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          children: hiredApplications
                                              .map<Widget>((app) {
                                            return ListTile(
                                              title: Text(
                                                  'Freelancer: ${app['freelancer']['name']}'),
                                              subtitle: Column(
                                                crossAxisAlignment:
                                                    CrossAxisAlignment.start,
                                                children: [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: widget.requests.isEmpty
          ? Center(child: Text('No requests just now'))
          : ListView.builder(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  'New Bid: \$${request['new_bid'] ?? 'No change'}'),
                              Text(
                              ...
                              ButtonBar(
                                children: [
                                  ElevatedButton(
                                    onPressed: () async {
                                      bool success = await acceptRequest(
                                          context, request['id']);
                                      if (success) {
                                        setState(() {
                                  ...
                                  ElevatedButton(
                                    onPressed: () async {
                                      bool success = await declineRequest(
                                          context, request['id']);
                                      if (success) {
                                        setState(() {
                                          widget.requests.removeAt(index);
