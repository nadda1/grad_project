...
class _SpecificJobPageState extends State<SpecificJobPage> {
  ...
  Future<List<dynamic>> fetchFreelancers() async {
    ...
    if (token != null) {
      final response = await http.get(
        Uri.parse(
            'https://snapwork-133ce78bbd88.herokuapp.com/api/freelancers/${widget
                .specializationId}'),
                  ...
                  child: ListTile(
                    ...
                    trailing: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Colors.white, backgroundColor: Color(0xFF69C26A), // Text color
  ...
  Future<void> fetchJobDetails() async {
    ...
    if (token != null) {
      final response = await http.get(
        Uri.parse(
            'https://snapwork-133ce78bbd88.herokuapp.com/api/jobs/${widget
                .jobId}'),
        headers: {'Authorization': 'Bearer $token'},
      );
  ...
  Widget buildApplicationCard(String freelancer,
      int id,
      String bid,
      String duration,
      String coverLetter,
        ...
        trailing: userid == userIDjob && userRole == "client"
          ...
          children: [
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: Color(
                    0xFF69C26A), // New color for "Hire" button
              ),
            ),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: Color(
                    0xFF87AFCC), // New color for "Contact" button
              ),
            ),
  ...
  Widget buildApplicationCardForFreelance(String freelancer,
      String coverLetter) {
        ...
        child: ListView(
          children: <Widget>[
              ...
              if (jobDetails['applications'].isEmpty)
                ...
                ...jobDetails['applications']
                    ...
                    buildApplicationCard(
                      ...
                      application['slug'],
                      application['freelancer'], // Pass the entire freelancer object
                    ))
                    .toList(),
            if (userRole == 'freelancer' &&
              ...
              ...jobDetails['applications']
                  .map((application) =>
                  buildApplicationCardForFreelance(
                    application['freelancer']['name'] ?? 'N/A',
                    application['cover_letter'] ?? 'N/A',
                  ))
                  .toList(),
