          ...
          TextButton(
            onPressed: ()async {
              ...
              final response = await http.put(
                Uri.parse('https://snapwork-133ce78bbd88.herokuapp.com/api/auth/update-employments'), // Use your actual API URL
                headers: <String, String>{
                  'Content-Type': 'application/json',
                  'Authorization': 'Bearer $token',
                },
                body: jsonEncode({ "employments": [{
        ...
        actions: <Widget>[
          ...
          TextButton(
            onPressed: ()async {
              ...
              final response = await http.put(
                Uri.parse('https://snapwork-133ce78bbd88.herokuapp.com/api/auth/update-skills'), // Use your actual API URL
                headers: <String, String>{
                  'Content-Type': 'application/json',
                  'Authorization': 'Bearer $token',
                },
        ...
        actions: <Widget>[
          ...
          TextButton(
            onPressed: ()async {
              ...
              final response = await http.put(
                Uri.parse('https://snapwork-133ce78bbd88.herokuapp.com/api/auth/update-certifications'), // Use your actual API URL
                headers: <String, String>{
                  'Content-Type': 'application/json',
                  'Authorization': 'Bearer $token',
                },
                body: jsonEncode({ "certifications": [{
