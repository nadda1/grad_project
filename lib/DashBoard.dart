...
class _PowerBIReportPageState extends State<PowerBIReportPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        initialUrl:
            'https://app.powerbi.com/reportEmbed?reportId=af90fc48-eac6-4c7e-9504-99facece773e&autoAuth=true&ctid=77255288-5298-4ea5-81aa-a13e604c30ac&filterPaneEnabled=false',
        javascriptMode: JavascriptMode.unrestricted,
        onWebViewCreated: (WebViewController webViewController) {
          this.webViewController = webViewController;
        },
        initialMediaPlaybackPolicy: AutoMediaPlaybackPolicy
            .always_allow, // Allow autoplay for media content
